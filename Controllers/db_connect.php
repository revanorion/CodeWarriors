...
$dbname = 'RESIDENCY';   // Needs to be changed to your designated table database name
$dbuser = 'residency_conn';   // Needs to be changed to reflect your LAMP server credentials
