        ...
        <form id="loginForm" class="form-group" action="../../Controllers/portal.php">
            <div class="row">
                ...
                <div class="form-group col-md-4">
                    <label for="Z-number">Z-number:</label>
                    <div class="input-group"> <span class="input-group-addon" id="basic-addon1">Z</span>
                        <input class="form-control" name="znumber" id="znumber" type="number" placeholder="Enter Z-number" aria-describedby="basic-addon1"> </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4"></div>
