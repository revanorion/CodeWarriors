...
?>
    ...
    <body>
        ...
        <div class="container-fluid body-content">
            <!-- OUR FORM -->
            <h2 style="font-family=sans-serif"><strong>RESIDENCY FORM</strong></h2>
            ...
            <div id="studentForm">
                ...
                <section>
                    ...
                    <form>
                        <div class="row form-group">
                            ...
                            <div class="col-md-2">
                                <input type="text" class="form-control" name="firstname" placeholder="Jon"> </div>
                    ...
                    <div>
                        <form action="">
                            ...
                            <div style="margin-top:15px">
                                <label style="display:block">TERM OF APPLICATION: (check one): </label>
                ...
                <section>
                    ...
                    <h3><strong>RESIDENCY DECLARATION:</strong></h3>
                    <div>
